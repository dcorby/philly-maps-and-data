...
data1 = gpd.read_file(tracts, bbox=bounds, crs="EPSG:4326").to_crs("EPSG:4326")
#data1.plot(ax=ax)

data2 = gpd.read_file(city_limits, bbox=bounds, crs="EPSG:4326").to_crs("EPSG:4326")




inter = gpd.clip(data1, data2)
